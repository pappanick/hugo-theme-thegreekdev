...
- [SEO Optimization](https://github.com/pappanick/hugo-theme-thegreekdev/blob/master/layouts/partials/seo.html)
...
```shell
git clone git@github.com:pappanick/hugo-theme-thegreekdev.git themes/yinyang
```
